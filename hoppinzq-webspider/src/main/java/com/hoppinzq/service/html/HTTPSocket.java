        ...
        try {
            ...
            do {
                ...
                if (attribute != null) {
                    ...
                    stringBuffer.append("\r\n");
                    Log.log(2, "请求头:" + attribute.getName() + "=" + attribute.getValue());
                }
            ...
            if (type != null) {
                Log.log(2, "Socket数据大小(" + type.length() + " bytes):" + new String(type));
            ...
            try {
                ...
                Log.logException("错误的 content-length:", e);
            }
